...
const foldersToDelete = ["public/images/pictures"];

const foldersToEmpty = ["public/audio", "public/data/sections"];
...
jsonUtils.overwrite(jSettingsPath, {
  ...
  consoleMessageForDevelopers: {
    ...
    items: [
      {
        description:
          "This is an open-source template based on the React framework.",
        list: [],
        listStyle: "none",
      },
      {
...
logger.log(
  logger.LogTypes.SUCCESS_FINISHED,
  "Successfully cleared resume data!",
);
